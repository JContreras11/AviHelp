...
<style>
  ...
  /* Marca Avi: Young Serif SOLO títulos; cuerpo en sans legible.
     Morado (primario/links) + teal (acento). */
  :root { --morado:#6D28D9; --morado-viv:#7C3AED; --teal:#00E4BE; --tinta:#1D1D1B; --gris:#5b6472; --linea:#e6e8ee; }
  * { box-sizing:border-box; }
  body { font-family:-apple-system,"Helvetica Neue",Arial,sans-serif; color:var(--tinta); font-size:11pt; line-height:1.6; margin:0; }
  h1,h2 { font-family:"Young Serif",Georgia,serif; letter-spacing:-.01em; }
  h3,h4 { font-family:-apple-system,"Helvetica Neue",Arial,sans-serif; }
  /* Portada */
  ...
  .cover h1 { font-size:30pt; color:var(--morado); margin:6px 0; }
  .cover .sub { font-size:13.5pt; color:var(--gris); max-width:135mm; }
  ...
  .cover .tag { display:inline-block; margin-top:10px; padding:6px 16px; border-radius:999px;
                background:var(--morado); color:#fff; font-size:9.5pt; font-weight:600; }
  .content { padding:0 2mm; }
  h1 { font-size:19pt; color:var(--morado); border-bottom:3px solid var(--teal);
  ...
  code { font-family:"SF Mono",Menlo,Consolas,monospace; font-size:9.5pt;
         background:#f2ecfd; color:var(--morado); padding:1px 5px; border-radius:4px; }
  ...
  th { background:var(--morado); color:#fff; text-align:left; padding:7px 9px; font-weight:600; }
  td { padding:6px 9px; border-bottom:1px solid var(--linea); vertical-align:top; }
  tr:nth-child(even) td { background:#f7f3ff; }
  table code { background:#f2ecfd; }
</style></head><body>
  <div class="cover">
